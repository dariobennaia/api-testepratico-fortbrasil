...
const rules = [
  ...
  check('password').optional().isLength({ min: 6, max:16 }).withMessage('A senha deve ter de 6 a 16 caracteres!'),
  
  check('email').optional().isEmail().withMessage('Campo email esta no formato inválido!'),
